...
<head>
    ...
    <body>
        ...
        <a class="navbar-brand" href="<?php echo base_url(); ?>">IGNIT</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>categories">Kategorien</a>
            </li>
            ...
            <?php if($this->session->userdata('logged_in')) : ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>categories/create">Kategorien hinzufügen</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>posts/create">Posten</a>
                </li>
                <li class="nav-item">
